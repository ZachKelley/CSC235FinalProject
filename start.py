...
bg = pygame.image.load("./EduardosSplash.png")
...
def run():
    ...
    if started:
        if counter < 200:
            ...
            text1 = font.render(
                "A fatal crash occurs with the mother ship leaving you stranded on an unknown planet called "
            ...
            text3 = font.render(
                "the ship to get back into orbit. While looking for pieces to the ship, you are encountered with a bug ",
                True, (255, 255, 255))

            text4 = font.render(
                "subspecies called the Zerg, they look as if they are multiplying and taking control of the spots to where ",
                True, (255, 255, 255))

            text5 = font.render(
                "pieces of the ship remain. Killing the Zerglings are needed to even get close to the ship reckages. ",
                True, (255, 255, 255))

            text6 = font.render(
                "The queen of the Zerg happens to be nesting around the radioactive power core to your ship.", True,
                (255, 255, 255))
